...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    ...
    title: 'Khushi Farms: Grow with Ethical Dairy Farming',
    description: 'An innovative cow wealth investment platform empowering rural India through sustainable and profitable ethical dairy farming plans.',
    cta: 'Case Study',
    image: '/assets/2.jpg',
    variant: 'featured',
    href: 'https://khushigrowth.com/',
  },
  {
    id: 'rupiksha',
    category: 'FINTECH',
    title: 'Rupiksha: Digital Payments Revolution',
    description: 'Empowering India\'s digital payment ecosystem with domestic money transfers, bill payments, banking APIs, insurance, and merchant wallet systems.',
    image: '/assets/rupiksha 1.jpg',
    variant: 'secondary',
    bgClass: 'bg-[#e8e8eb]',
    textClass: 'text-[#00273d]',
    categoryClass: 'text-[#006d3d]',
    href: 'https://rupiksha.com',
  },
  {
    id: 'ucipl',
    category: 'FINTECH',
    title: 'MicroCircuits Innovations',
    description: 'A premium semiconductor and IC design services platform specializing in VLSI design, physical design, DFT, and sign-off verification solutions.',
    image: '/assets/3micro circuit.jpg',
    variant: 'secondary',
    bgClass: 'bg-[#00273d]',
    textClass: 'text-white',
    categoryClass: 'text-[#6cfda8]',
    href: 'https://www.ucipl.in/#/expertise',
  },
  {
    id: 'wellbeing',
...
export const CONTACT_DETAILS: ContactDetail[] = [
  {
    title: 'Call Us',
    value: '+91 - 96255 67013',
    href: 'tel:+91 9625567013',
    icon: 'Phone',
  },
  {
    title: 'WhatsApp',
    value: '+91 96255 67013',
    href: 'https://wa.me/919625567013',
    icon: 'WhatsApp',
  },
  {
    title: 'Email Us',
    value: 'info@logiccentra.com',
    href: 'mailto:info@logiccentra.com',
    icon: 'Mail',
  },
  {
    title: 'Location',
